  ...
  return template(
    ...
    r('main', [
      ...
      section([
        ...
        r('p', 'Minified and gzipped the library is about <code><b>8kB</b></code>, and when the state or document changes only relevant directives are executed making updates fast.'),
      ]),
