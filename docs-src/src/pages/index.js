...
export default () => {
	return template(
		...
		{
			description:
				"Doars will scan the web page and process the directives found as well as keep the state and content up to date.",
			keywords: [
				"doars",
				"javascript",
				"minimal",
		...
		r("main", [
							...
							"button",
							{
								...
								onclick: () => {
									window.copyToClipboard(
										"https://cdn.jsdelivr.net/npm/@doars/doars@3/dst/doars.iife.js",
									);
								},
							},
							[
				...
				r(
					...
					[
						...
						r(
							...
							{
								class:
									"card-example -mt-1.5 ml-auto mr-3 md:-mr-1.25 -rotate-2 transform",
							},
							[
								r(
									"div",
				...
				r(
					...
					[
						...
						r(
							...
							{
								class:
									"card-example -mt-1.5 ml-auto mr-3 md:-ml-1.25 rotate-2 transform",
							},
							[
								r(
									"div",
			...
			section([
				...
				r(
					"p",
					"Minified and compressed the library is <code><b>11kB</b></code>, and when the state or document changes only relevant directives are executed making updates fast.",
				),
			]),
					...
					carousel(
						...
						[
							card(
								...
								"d-state",
								"Define a component and set its initial state.",
							),
							...
							card(
								...
								"d-reference",
								"Add the element to the component's references context.",
							),
							...
							card(
								...
								"d-text",
								"Set the inner text or text content of the element.",
							),
							...
							card(
								...
								"d-select",
								"Set selected item of a select element or selectable input elements.",
							),
							...
							card(
								...
								"d-sync",
								"Keep the value of an element in sync with a value in the state or store.",
							),
							...
							card(
								...
								"d-transition",
								"Change attributes on an element when being hidden or shown.",
							),
							...
							card(
								...
								"d-if",
								"Return whether the template should be added to the document.",
							),
							...
							card(
								...
								"d-for",
								"Loop over a value and create elements based on a template.",
							),
							...
							card(
								...
								"d-watch",
								"Runs every time a value used changes.",
							),
					...
					carousel(
						...
						[
							...
							card(
								...
								"$for",
								"Get variables defined in the for directive.",
							),
							...
							card(
								...
								"$nextTick",
								"Execute a function after updates are done processing.",
							),
							...
							card(
								...
								"$inContext",
								"Execute a function in context after the existing one has been revoked.",
							),
					...
					carousel(
						...
						[
							...
							card(
								...
								"Adds a navigation directive that loads pages without unloading the current page by listening to anchor tags.",
							),
							...
							card(
								...
								"@doars/doars-persist",
								"Adds cookies, local storage, and sessions storage contexts to get and set persistent data.",
							),
							...
							card(
								...
								"Adds an intersect directive for reacting to intersection changes.",
							),
							...
							card(
								...
								"@doars/doars-router",
								"Adds a router context with set of directives to control it.",
							),
							...
							card(
								...
								"@doars/doars-update",
								"Adds an update loop context and directive.",
							),
						],
					),
				],
